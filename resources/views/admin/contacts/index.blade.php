...
<div class="col-md-9">
  <div class="box box-primary">
    ...
    <div class="box-body no-padding">
      <form action="{{ route('admin.contacts.delmore') }}" method="post">
        {{ csrf_field() }}
          ...
          <table class="table table-hover table-striped">
            <tbody>
              ...
              <tr>
                ...
                <td class="mailbox-star changeI-{{ $arContact['id'] }}">
                  <a href="javascript:void(0)" onclick="changeImp({{ $arContact['id'] }}, {{ $qt }})" title="{{ $titleC }}">
                    <i class="fa fa-star{{ $imp }}" aria-hidden="true"></i>
                  </a>
                </td>
